...
const user = {
  state: {
    currentUserProfile: {}, //!{adminForbidType,allowType,avatar,birthday,gender,language,lastUpdatedTime,level,location,messageSettings,nick,profileCustomField,role,selfSignature,userID}
    isLogin: false,
